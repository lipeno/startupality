website.controller('CanvasController', function ($scope, $dialog, StorageService){
    $scope.sections = [];
//    Initialize
    var element = {
        title: 'Problem',
...
//    Persistence
    ...
    $scope.openDialog = function(item){
        ...
        $scope.opts = {
            ...
            templateUrl:  'partials/canvasDialog.html', // OR: templateUrl: 'path/to/view.html',
...
website.controller('CanvasDialogController', function ($scope, dialog, item, StorageService){
    $scope.item = item;
    $scope.select2init = {
